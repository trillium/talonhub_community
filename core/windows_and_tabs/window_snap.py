...
_snap_positions = {
    ...
    "first third": RelativeScreenPos(0, 0, 1 / 3, 1),
    "right third": RelativeScreenPos(2 / 3, 0, 1, 1),
    "last third": RelativeScreenPos(2 / 3, 0, 1, 1),
    ...
    "maximum": RelativeScreenPos(0, 0, 1, 1),
